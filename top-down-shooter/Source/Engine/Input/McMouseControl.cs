...
namespace top_down_shooter
{
    public class McMouseControl
    {
        ...
        // First mouse is important for when we click and drag. It is set when you click.
        // FirstMouse stores the first location, then the distance can be calculated
        ...
        {
            // This is actually what the mousePos declarations would be like every time if they weren't declared up top
